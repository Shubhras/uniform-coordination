...
MIDDLEWARE = [
    ...
    'uniformAdmin.middleware.APILanguageMiddleware',
...
# SITE_DOMAIN = "http://table.172.237.71.124.sslip.io"
SITE_DOMAIN = "https://table-admin.dxtspace.com"

# SITE_URL = "http://table.172.237.71.124.sslip.io"
...
"stripe payment"
STRIPE_SECRET_KEY = config("STRIPE_SECRET_KEY", default="test")
STRIPE_PUBLISHABLE_KEY = config("STRIPE_PUBLISHABLE_KEY", default="test")
STRIPE_WEBHOOK_SECRET = config("STRIPE_WEBHOOK_SECRET", default="test")
# import os
