                    ...
                    <tbody>
                        {loading ? (
                            ...
                            Array.from({ length: 5 }).map((_, i) => (
                                <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-[#1C4FA80F]"}>
                            ...
                            filteredFabrics.map((fabric, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-5 py-4">
                                        <span className={`text-xs font-medium px-2 py-1 rounded-full ${fabric.isActive
            ...
            {!loading && pagination.total_pages > 1 && (
                <div className="flex items-center justify-between mt-6 px-2">
                    <p className="text-sm text-[#64748B]">
                        Showing page {pagination.page} of {pagination.total_pages} ({pagination.total_items} items)
                    </p>
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        {getPageNumbers().map((page, idx) => (
                            <button
                                ...
                                disabled={page === '...'}
                                className={`w-9 h-9 rounded-md text-sm font-medium transition-colors ${page === currentPage
