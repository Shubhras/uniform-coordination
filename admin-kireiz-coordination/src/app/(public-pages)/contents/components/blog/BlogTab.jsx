    ...
    <>
      <div className="bg-[#F4F7FC] rounded-xl shadow md:p-6 p-3">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 text-[#94A3B8]">No blog posts found</div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredPosts.map((post) => (
              ...
              >
                <div className="p-3">
                  <img
                    src={post.image || "/img/kireiz-form/features/Rectangle177.png"}
                    alt={post.title}
                ...
                <div className="px-5 pb-6 flex flex-col gap-3">
                  <p className="text-xs text-gray-500 mb-2">
                    {formatDate(post.created_at)} &nbsp;&nbsp; {post.categoryName}
                  </p>
        ...
        {!loading && pagination.total_pages > 1 && (
          <div className="flex items-center justify-between mt-6 px-2">
            <p className="text-sm text-[#64748B]">
              Page {pagination.page} of {pagination.total_pages} ({pagination.total_items || posts.length} items)
            </p>
