...
const quotes = [
    { id: "Q-2024-001", company: "Acme Corp", amount: "$125,000", date: "Oct 24, 2023", status: "Approved" },
    { id: "Q-2024-002", company: "Globex Inc", amount: "$45,000", date: "Oct 25, 2023", status: "Pending" },
    { id: "Q-2024-003", company: "Soylent Corp", amount: "$12,000", date: "Oct 26, 2023", status: "Rejected" },
    { id: "Q-2024-004", company: "Initech", amount: "$85,000", date: "Oct 27, 2023", status: "Pending" },
    { id: "Q-2024-005", company: "Umbrella Corp", amount: "$450,000", date: "Oct 28, 2023", status: "Approved" },
    { id: "Q-2024-006", company: "Stark Ind", amount: "$950,000", date: "Oct 29, 2023", status: "Pending" },
    { id: "Q-2024-007", company: "Wayne Ent", amount: "$320,000", date: "Oct 30, 2023", status: "Approved" },
    { id: "Q-2024-008", company: "Cyberdyne", amount: "$67,000", date: "Oct 31, 2023", status: "Rejected" },
];
    ...
    return (
        <div className="bg-white md:p-6 p-3 rounded-xl shadow border border-gray-200">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div>
                    <h1 className="text-xl font-semibold text-[#1C2C56]">Quotation History</h1>
            ...
            <div className="overflow-hidden border border-gray-200 rounded-lg">
                <table className="w-full text-sm text-left">
                    ...
                    <tbody>
                        {quotes.map((q, i) => (
                            <tr key={i} className="border-b last:border-none border-[#E2E8F0] hover:bg-gray-50 transition">
