...
import { FiArrowLeft, FiFileText, FiMapPin } from 'react-icons/fi'
    ...
    return (
        <div className="mx-auto w-full max-w-7xl rounded-2xl bg-[#F5F0EE30] p-5 shadow-md md:p-8">
            ...
            <div className="space-y-5">
                    ...
                    <SectionCard icon={<FiFileText size={16} />} title="Quotation Information">
                        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            ...
                            <InfoField
                                ...
                                accentClassName={quotationStatusStyles[quotation.quotationStatus] || 'text-[#F04438]'}
                            />
                ...
                <SectionCard icon={<FiFileText size={16} />} title="Reason For Rejection">
                    <p className="text-sm leading-7 text-[#6D5548]">
                        {quotation.rejectionReason || quotation.notes}
                    </p>
                </SectionCard>
            </div>
        </div>
...
export default RejectedQuotationDetail