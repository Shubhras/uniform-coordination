    ...
    <div className="min-h-screen bg-[#FAF8F6] px-6 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 px-5 h-10 rounded-lg bg-[#FFF1F0] text-[#F04438] text-sm font-medium hover:bg-[#FFE4E2] transition">
            <FiTrash2 size={15} />
            Delete Product
          </button>

          <button className="flex items-center gap-2 px-5 h-10 rounded-lg bg-[#A0522D] text-white text-sm font-medium hover:bg-[#914A27] transition">
            <FiEdit2 size={15} />
            Edit Product
          </button>
        </div>
