  ...
  return (
    <>
      <Split>
        <div className="mx-4">
          <div className="mb-6">
            <h2 className="font-[Plus Jakarta Sans]  font-medium text-[28px] tracking-[0.18px] text-[#402936] mb-1">
            ...
            <p className="font-[Plus Jakarta Sans] font-medium text-sm  tracking-[0.15px] text-[#4C4E64AD]">
              ...
              Manage Rentals, Orders & Business Operations
            </p>
          </div>
          {message && (
                ...
                <div className="mb-6 mt-2 flex justify-between items-center">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <div className="relative w-5 h-5 shrink-0 flex items-center justify-center">
                      <input
                        type="checkbox"
                        className="peer appearance-none w-5 h-5 border-2 border-gray-300 rounded bg-white checked:bg-[#A0522D] checked:border-[#A0522D] cursor-pointer transition-all m-0"
                      />
                      <svg
                  ...
                  <ActionLink
                    ...
                    className="text-[#A0522D] heading-text text-sm"
                    themeColor={false}
                  >
                    Forgot Password?
                  </ActionLink>
          ...
          {/* <div className="mt-3 text-center text-base">
                        ...
                        <ActionLink
                            href={signUpUrl}
                            className="heading-text text-[#A0522D]"
                            themeColor={false}
                        >
                            Create an account
                        </ActionLink>
