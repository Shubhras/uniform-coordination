...
class PaymentIntentAPIView(APIView):
    ...
    def post(self, request):
        ...
        STRIPE_ALLOWED_METHODS = ["card", "upi", "bank_transfer", "apple_pay", "google_pay"]
...
class UserPaymentDetailAPIView(APIView):
    ...
    def get(self, request):
        try:
            payments = Payment.objects.filter(order__user=request.user).order_by("-paid_at")
...
class UserSinglePaymentDetailAPIView(APIView):
    permission_classes = [IsAuthenticated]
...
#             paid_users = Payment.objects.values('order__user__id', 'order__user__name') \
#                                         .annotate(
...
#                 "paid_users_count": paid_users.count(),
#                 "paid_users": list(paid_users)
#             }

#             return Response({
#                 "status": True,
#                 "message": "Admin payment report",
#                 "data": report
#             })
