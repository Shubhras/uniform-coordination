 ...
 * Displays the hero banner for the medical category with dynamic category image, title, description, and collection link.
 *
        ...
        <div className="relative mx-auto">
            ...
            <div className="absolute left-0  w-[45%] z-0 -bottom-10">
              <div className="bg-gradient-to-r to-[#dce4f7] from-white rounded-tl-[60px] rounded-tr-[60px] rounded-br-[60px] px-16 py-40 shadow-[0_30px_80px_rgba(28,44,86,0.15)]">
                ...
                <button
                  ...
                  className="bg-[#1C2C56] text-white px-6 py-3 rounded-md text-sm font-medium w-fit cursor-pointer"
                >
          ...
          <div className="lg:hidden flex flex-col gap-6">
            ...
            <div className="text-center px-2 pb-8">
              ...
              <button
                onClick={() => router.push("/kireiz-form")}
                className="bg-[#1C2C56] text-white px-6 py-2 rounded-md text-sm font-medium cursor-pointer"
              >
                Browse All Collection
              </button>
            </div>
