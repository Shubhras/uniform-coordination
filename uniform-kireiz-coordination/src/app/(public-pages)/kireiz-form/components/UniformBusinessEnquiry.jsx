      ...
      <div className="mx-auto bg-[#EEF3FB] rounded-tr-[120px]">
        ...
        >
          {[
            ...
            <div
              key={i}
              className="bg-white rounded-xl border border-gray-200 shadow-sm px-4 py-5 hover:shadow-md transition"
            >
              <Image src={item.img} width={40} height={40} alt={item.title} />
              <p className="text-[#1C2C56] font-semibold text-sm mt-2">
                {item.title}
              </p>
