    ...
    <div className="mx-auto max-w-7xl space-y-6 bg-[#F9FAFB]">
      <div className="rounded-[12px] border border-[#E2E8F0] bg-[#F6FAFF] p-4 md:px-5 md:py-4">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:gap-4">
          ...
          <div className="relative flex-1 pr-0 md:pr-[110px]">
            <span className="mt-3 inline-flex w-fit items-center gap-1 rounded-full bg-[#DCFCE7] px-2.5 py-1 text-[10px] font-medium text-[#10B981] md:absolute md:right-3 md:-top-2 md:mb-0 md:shadow-[0_0_0_6px_#F6FAFF]">
        ...
        <div className="mt-3 flex flex-wrap gap-2 pl-0 md:pl-[142px]">
          <Button
            ...
            className="h-7 whitespace-nowrap rounded-md border border-[#E5E7EB] px-3 text-[11px] font-medium leading-none text-[#475569]"
      ...
      <div className="overflow-hidden rounded-[10px] border border-[#8DB4E2] bg-white p-1">
        <div className="flex items-center justify-between border-b border-[#E5EDF7] px-4 py-3">
          <div>
            <h4 className="text-[20px] font-medium text-[#1C4FA8]">
              Quotation Status
            </h4>
            <p className="mt-1 text-[12px] text-[#003560]">
              {activeQuotation?.quotationNo ||
                activeQuotation?.quotation_id ||
                "RQ-2025-0194"}
            </p>
            <p className="text-[10px] mt-1 text-[#000000] font-medium">
              {formatDisplayDate(activeQuotation?.created_at)}
            </p>
          </div>

          <Button className="rounded-md h-8 bg-[#003560] px-4 py-1 text-xs text-white hover:bg-[#002a49]">
            View Design
          </Button>
        </div>
          ...
          {quotationLoading ? (
            ...
            quotationData.slice(0, 3).map((quotation, index) => (
              <div
                ...
                className="flex items-center justify-between rounded-lg  bg-[#F8FBFF] px-4 py-2"
              >
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="overflow-hidden rounded-[10px] border border-[#E5EDF7] bg-white p-1">
          <div className="flex items-center justify-between border-b border-[#EEF2F7] px-5 py-4">
            <h4 className="flex items-center gap-2 text-[15px] font-medium text-[#1E293B]">
              <FiBox size={17} />
              Recent Quotation
            </h4>
            <button
              className="flex items-center gap-1 text-[11px] text-[#2563A8]"
        ...
        <div className="overflow-hidden rounded-[14px] border border-[#E5EDF7] bg-white p-1">
          <div className="flex items-center justify-between border-b border-[#EEF2F7] px-5 py-4">
            ...
            <button
              className="flex items-center gap-1 text-[12px] font-medium text-[#2563A8]"
                  ...
                  >
                    <div className="flex min-w-0 gap-3">
                      ...
                      <div className="min-w-0 space-y-2">
                        ...
                        <div className="flex items-center gap-1 text-[11px] font-normal text-[#9CA3AF]">
                    ...
                    <div className="flex shrink-0 flex-col items-end gap-5 pt-0.5 text-right">
                      <span
                        className={`inline-flex justify-center rounded-[4px] px-3 py-2 text-[9px] font-semibold leading-none ${
                          item?.isActive
